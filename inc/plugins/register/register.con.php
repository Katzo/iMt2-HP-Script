		...
		$content = array(
			...
			"middle" => array(
				"text" => '<form method="POST"><table>
							<tr><td>'.$lang["misc"]["user"].'</td><td><input class="bar" type="text" placeholder="'.$lang["misc"]["user"].'" name="user" id="user" onblur="javascript:regcheck(\'user\');"/></td><td id="userres"></td></tr>
