...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="'.$settings->get("baseurl").'css/style.css" />
    <!--[if lte IE 7]><link rel="stylesheet" type="text/css" media="screen" href="'.$settings->get("baseurl").'css/ie7.css" /><![endif]-->
</head>
<body>
	 <div id="wrapper">
		<div id="header">
			<a id="logo" href="'.$settings->get("baseurl").'" title="Logo"><img src="'.$settings->get("baseurl").'images/logo/logo.png" alt="Logo" /></a>
		</div>
		<div id="navbar">
	...
	if (isset($ar["plain"]))
		...
		echo '
					...
					<div class="postui post-con">
						<div class="con-wrap">
							<p>'.((isset($ar["middle"]["img"]))?'<img class="thumb" src="'.(isURL($ar["middle"]["img"]["src"])?$ar["middle"]["img"]["src"]:$settings->get("baseurl").$ar["middle"]["img"]["src"]).'" alt="'.$ar["middle"]["img"]["alt"].'" />':'').$ar["middle"]["text"].'</p>
