		...
		if (isset($ar["plain"]))
			...
			echo '
					...
					<div class="postui post-con">
						<div class="con-wrap">
							<p>'.((isset($ar["middle"]["img"]))?'<img class="thumb" src="'.(isURL($ar["middle"]["img"]["src"])?$ar["middle"]["img"]["src"]:$config["baseurl"].$ar["middle"]["img"]["src"]).'" alt="'.$ar["middle"]["img"]["alt"].'" />':'').$ar["middle"]["text"].'</p>
