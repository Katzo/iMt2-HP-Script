...
$lang = array(
	...
	"reg" => array(
		...
		"secqminlen_error" => "Deine Sicherheitsfrage muss mindestens %len Zeichen lang sein",
		"secqmaxlen_error" => "Deine Sicherheitsfrage darf maximal %len Zeichen lang sein",
		"secaminlen_error" => "Deine Antwort muss mindestens %len Zeichen lang sein",
		"secamaxlen_error" => "Deine Antwort darf maximal %len Zeichen lang sein",
	...
	"settings" => array(
		...
		"pass_error" => "Das Passwort stimmt nicht &uuml;berein!",
		...
		"safebox_reset" => "Dein Lagerpasswort wurde erfolgreich zur&uuml;ckgesetzt! (Es ist jetzt <b>0000000</b>)",
	...
	"vote" => array(
		...
		"success" => "Du hast erfolgreich gevoted!",
		"fail" => "Du hast nicht gevoted. Bitte versuche es erneut",
	)
);
